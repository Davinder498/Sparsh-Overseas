...
export type View = 'LOGIN' | 'LANDING' | 'HOME_PAGE' | 'PENSIONER_DASHBOARD' | 'NOTARY_DASHBOARD' | 'PERSONAL_DETAIL' | 'ACCOUNT_SETTING' | 'SERVICE_UNAVAILABLE' | 'FAMILY_PENSION' | 'UPDATE_EMAIL' | 'UPDATE_ID' | 'REQUEST_DOCUMENTS' | 'NOTARY_REPORTS';
